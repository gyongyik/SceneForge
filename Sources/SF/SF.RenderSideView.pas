  ...
  case DefaultObject of
      ...
      begin
        ...
        begin
          Grid := TRectangle.CreateRectangle(
            Integer(DefaultSubX), Integer(DefaultSubY), P1, P2, vmSide, Scene.TextureManager.SelectedTexture, DefaultRectDoubleSided);
          Grid.AutoUV := True;
    ...
    otBox:
      begin
        ...
        begin
          Box := TBox.CreateBox(
            vmSide, P1, P2, Integer(DefaultDivX), Integer(DefaultDivY), Integer(DefaultDivZ), Scene.TextureManager.SelectedTexture);
          Box.AutoUV := True;
...
procedure TRenderSideView.UpdateProjection(Width, Height: Integer);
begin
...
function TRenderSideView.ConvertPoint(X, Y: Integer): TInteger2;
begin
  Result.X := Trunc(Base.Z + X * PX);
  Result.Y := Trunc(-Base.Y + SY - Y * PY);
end;

procedure TRenderSideView.DrawGrid(GridSize, SkipSize: Integer; Color: TRGBColor);
var
...
procedure TRenderSideView.DrawViewport(ShouldMakeCurrent: Boolean);
var
  I, J, K: Integer;
  Obj: TObject3D;
  Face: TFace;
